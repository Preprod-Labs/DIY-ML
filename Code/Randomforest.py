...
rf_model=RandomForestRegressor(n_estimators=10,max_depth=3,max_leaf_nodes=2)

#FIT THE MODEL ON TRAIN DATA
rf_model.fit(Xtrain,ytrain)

#PREDICT MODEL OUTPUTS ON TEST DATA
rf_yprd=rf_model.predict(Xtest)

#EVALUATE THE MODEL OUTPUTS YPRED AND YACTUAL (YTEST) USING METRICS
rf_mse = mean_squared_error(ytest,rf_yprd)
rf_r2 = r2_score(ytest,rf_yprd)

#PRINT THE METRICS
print("mse of lr model:",rf_mse)
print("r2 of lr model:",rf_r2)

#Save the model
with open(modelpath+'rfmodel.sav', 'wb') as f:
